...
class Kafka(ComponentBase):
    ...
    def start(self):
        ...
        kafka_ips = self.metadata.get("kafka_ips", ["127.0.0.1:9092"])
        ...
        try:
            ...
            self.eprint("ERROR", f"Error running listener executable. See: {e}")
    ...
    def _create_pid_file(self, pid):
        ...
        try:
            ...
            self.eprint("ERROR", f"Could not create PID file. Listener process at PID {pid} will not terminate automatically when experiment ends. See: {e}")
    ...
    def _consume_pid_file(self):
        ...
        try: 
            ...
            self.eprint("ERROR", f"Error consuming PID file. Listener process at PID {pid} will not be terminated. See: {e}")
            return pid
    ...
    def stop(self):
        ...
        try:
            ...
            self.eprint("ERROR", f"Error terminating listener at PID {pid}. See: {e}")
